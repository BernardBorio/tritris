const Cross = (props: any) => {
 return (
  <svg width={props.width} height={props.height} version="1.1" viewBox="0 0 89.534 89.534" xmlns="http://www.w3.org/2000/svg">
   <g transform="translate(-66.85 -80.077)">
    <g fill={props.fill} stroke="#000" stroke-linecap="square" stroke-miterlimit="100" stroke-width="0">
